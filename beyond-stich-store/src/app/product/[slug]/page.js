...
export default function ProductDetailPage(props) {
  ...
  // Fetch product through the data-access layer (DB swap happens there).
  ...
  const [reviewData, setReviewData] = useState({ reviews: [], average: 0, count: 0, distribution: {} });
  ...
  const checkDelivery = (e) => {
    ...
    // Estimated delivery: 3–6 days out (metro PINs starting 1/4/5/7 are faster).
      ...
      <div className={`${styles.grid} container`}>
        ...
        <div className={styles.infoCol}>
          <div className={styles.infoSticky}>
            ...
            {/* Social proof — real, review-based (only shows once reviews exist) */}
            {reviewData.count > 0 && (
